...
export function ProUpgradeEmail({ plan, amount, billingPeriod, nextBillingDate, dashboardUrl }: ProUpgradeEmailProps) {
  return (
    <EmailLayout preview="Your subscription is active. Unlimited reels, full progress tracking.">
      ...
      <Text style={{ fontSize: 15, lineHeight: 1.6, color: emailStyles.textSecondary }}>
        You now have unlimited Via reels, full progress tracking, and weekly practice plans. Start uploading.
      </Text>
      <EmailButton href={dashboardUrl}>Go to your dashboard →</EmailButton>
      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 20 }}>
        {['∞ Unlimited reels', '📈 Progress timeline', '📋 Weekly practice plans'].map(item => (
