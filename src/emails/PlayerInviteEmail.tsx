...
export function PlayerInviteEmail({ coachName, sport, inviteUrl }: PlayerInviteEmailProps) {
  return (
    <EmailLayout preview="Accept your invite to view training, drills, and AI coaching feedback">
      ...
      <Text style={{ fontSize: 15, lineHeight: 1.6, color: emailStyles.textSecondary }}>
        {coachName} has added you to Playvia — your coaching hub for training, drills, and Via Reels.
      </Text>
