...
export function AnalysisCompleteEmail({ sport, shotType, overallScore, rating, topIssue, biggestWin, analysisUrl }: AnalysisCompleteEmailProps) {
  return (
    <EmailLayout preview="See your technique breakdown and coaching recommendations">
      <Heading style={{ fontSize: 26, margin: '0 0 20px', color: emailStyles.text }}>Your reel is ready</Heading>
      ...
      <div style={{ display: 'flex', gap: 12, margin: '20px 0' }}>
        <div style={{ flex: 1, background: '#DCFCE7', borderRadius: 12, padding: 14 }}>
          ...
          <div style={{ fontSize: 13, lineHeight: 1.5, color: '#14532D' }}>{biggestWin || 'Your reel is ready to review — you have a clear baseline.'}</div>
        </div>
      ...
      <EmailButton href={analysisUrl}>View your reel →</EmailButton>
